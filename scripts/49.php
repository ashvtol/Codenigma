...
<input name="next" type="submit" id="next" value="Next" onclick= "window.location='50.php'" />
<input name="back" type="submit" id="back" value="Back" onclick= "window.location='48.php'" />
...
if($found_user['q49']==-1) //change question id ie. 'q1' for other questions.
{
...
<form action="ans.php?id=49" method="post" id="fq1"> <!-- Change 'id' according to the question number -->
...
<input name="q49" type="radio" value="1">#option1</input>&nbsp;&nbsp;&nbsp;  
<input name="q49" type="radio" value="2">#option2</input>&nbsp;&nbsp;&nbsp;
<input name="q49" type="radio" value="3">#option3</input>&nbsp;&nbsp;&nbsp;
<input name="q49" type="radio" value="4">#option4</input>&nbsp;&nbsp;&nbsp;
</div>
