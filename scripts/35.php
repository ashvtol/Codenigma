...
<input name="next" type="submit" id="next" value="Next" onclick= "window.location='36.php'" />
<input name="back" type="submit" id="back" value="Back" onclick= "window.location='34.php'" />
...
if($found_user['q35']==-1) //change question id ie. 'q1' for other questions.
{
...
<form action="ans.php?id=35" method="post" id="fq1"> <!-- Change 'id' according to the question number -->
<div id="questions" style="display:none;">
<p><pre>
A derived class in C# can stop virtual inheritance by 
declaring an override as
</pre>
</p>
<hr>
<pre>
...
<input name="q35" type="radio" value="1">#option1</input>&nbsp;&nbsp;&nbsp;  
<input name="q35" type="radio" value="2">#option2</input>&nbsp;&nbsp;&nbsp;
<input name="q35" type="radio" value="3">#option3</input>&nbsp;&nbsp;&nbsp;
<input name="q35" type="radio" value="4">#option4</input>&nbsp;&nbsp;&nbsp;
</div>
