...
if($found_user['q51']==-1) //change question id ie. 'q1' for other questions.
{
...
<form action="51check.php?id=51" method="post" id="fq1"> <!-- Change 'id' according to the question number -->
<div id="questions" style="display:none;">
<h2>Score Booster</h2><p>
<pre>The Hello World Question
