...
<input name="next" type="submit" id="next" value="Next" onclick= "window.location='12.php'" />
<input name="back" type="submit" id="back" value="Back" onclick= "window.location='10.php'" />
