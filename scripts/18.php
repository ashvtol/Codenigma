...
<input name="next" type="submit" id="next" value="Next" onclick= "window.location='19.php'" />
<input name="back" type="submit" id="back" value="Back" onclick= "window.location='17.php'" />
...
if($found_user['q18']==-1) //change question id ie. 'q1' for other questions.
{
...
<form action="ans.php?id=18" method="post" id="fq1"> <!-- Change 'id' according to the question number -->
...
<input name="q18" type="radio" value="1">#option1</input>&nbsp;&nbsp;&nbsp;  
<input name="q18" type="radio" value="2">#option2</input>&nbsp;&nbsp;&nbsp;
<input name="q18" type="radio" value="3">#option3</input>&nbsp;&nbsp;&nbsp;
<input name="q18" type="radio" value="4">#option4</input>&nbsp;&nbsp;&nbsp;
</div>
