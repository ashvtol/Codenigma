...
*/
 ...
 $ACCESS_PWD='nevermind!@#'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"codenigma",#required
 'pwd'=>"3=^pDTB}]F?g", #required
 'db'=>"test_db",  #optional, default DB
